...
from "firebase/auth";
  ...
  // Replace 'import' with 'require' (CommonJS style)
...
// If you need to require specific functions from your project file, use require here
const {
  changeImage,
  toggleSearch,
  fetchFeaturedBooks,
...
} = require("/Users/temmy/Desktop/PageTurners/PageTurners/project.js");

// Mocking FileReader directly without using file-api
global.FileReader = class {
  ...
  readAsDataURL(file) {
    // Simulate file read with a dummy data URL
    setTimeout(() => {
  ...
  readAsText(file) {
    // Simulate reading as text (if needed)
    setTimeout(() => {
      this.result = "dummy text content";
      if (this.onload) this.onload();
    }, 100);
  }
};
